...
//
//   var data = {title: 'AliExpress', body: 'Something new happened!', icon: 'https://m.aliexpress.com/img/android-chrome-192x192.png', click_action: 'https://m.aliexpress.com'};
//   var options = {};
//   if (event.data) {
...
var version = '0.0.1'
importScripts( `https://assets.alicdn.com/g/ae-fe-user-growth/web-push-client/${version}/ae-sw.js`);